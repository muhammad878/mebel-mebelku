...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $users = $db->admin; // Menghubungkan ke koleksi 'admin'
    ...
    if ($existingUser) {
        ...
        $success_message = "Registrasi berhasil. <a href='loginad.php'>Login di sini</a>";
    }
}
?>
<!DOCTYPE html>
...
<body>
    <div class="container">
        ...
        <div class="right">
            ...
            <div class="help">
                <a href="loginad.php">Already have an account? Login!</a>
            </div>
        </div>
    </div>
</body>
